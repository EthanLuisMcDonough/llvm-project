...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__lightsan_post_base_pointer_info(ptr [[A]], i32 0, i32 -1)
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__lightsan_pre_store(ptr [[A]], ptr [[TMP3]], i32 1, i32 1)
; CHECK-NEXT:    store i8 1, ptr [[TMP0]], align 1
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 1
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__lightsan_pre_load(ptr [[ARRAYIDX]], ptr [[TMP3]], i32 1, i32 2)
...
; CHECK-SAME: ptr noundef captures(none) initializes((0, 1)) [[A:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__lightsan_post_base_pointer_info(ptr [[A]], i32 0, i32 -3)
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__lightsan_pre_store(ptr [[A]], ptr [[TMP3]], i32 1, i32 3)
; CHECK-NEXT:    store i8 1, ptr [[TMP0]], align 1
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 1
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__lightsan_pre_load(ptr [[ARRAYIDX]], ptr [[TMP3]], i32 1, i32 4)
; CHECK-NEXT:    [[TMP2:%.*]] = load i8, ptr [[TMP1]], align 1
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__lightsan_post_base_pointer_info(ptr [[A]], i32 0, i32 -5)
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__lightsan_pre_store(ptr [[A]], ptr [[TMP3]], i32 2, i32 5)
; CHECK-NEXT:    store i16 2, ptr [[TMP0]], align 2
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 2
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__lightsan_pre_load(ptr [[ARRAYIDX]], ptr [[TMP3]], i32 2, i32 6)
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__lightsan_post_base_pointer_info(ptr [[A]], i32 0, i32 -7)
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__lightsan_pre_store(ptr [[A]], ptr [[TMP3]], i32 4, i32 7)
; CHECK-NEXT:    store i32 3, ptr [[TMP0]], align 4
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 4
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__lightsan_pre_load(ptr [[ARRAYIDX]], ptr [[TMP3]], i32 4, i32 8)
...
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__lightsan_pre_load(ptr [[ARRAYIDX]], ptr [[TMP0]], i32 16, i32 12)
...
; CHECK-SAME: ptr noundef captures(none) initializes((0, 4)) [[A:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__lightsan_post_base_pointer_info(ptr [[A]], i32 0, i32 -13)
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__lightsan_pre_store(ptr [[A]], ptr [[TMP3]], i32 4, i32 13)
; CHECK-NEXT:    store float 6.000000e+00, ptr [[TMP0]], align 4
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 4
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__lightsan_pre_load(ptr [[ARRAYIDX]], ptr [[TMP3]], i32 4, i32 14)
...
; CHECK-SAME: ptr noundef captures(none) initializes((0, 8)) [[A:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__lightsan_post_base_pointer_info(ptr [[A]], i32 0, i32 -15)
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__lightsan_pre_store(ptr [[A]], ptr [[TMP3]], i32 8, i32 15)
; CHECK-NEXT:    store double 7.000000e+00, ptr [[TMP0]], align 8
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 8
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__lightsan_pre_load(ptr [[ARRAYIDX]], ptr [[TMP3]], i32 8, i32 16)
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__lightsan_post_base_pointer_info(ptr [[A]], i32 0, i32 -17)
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__lightsan_pre_store(ptr [[A]], ptr [[TMP2]], i32 10, i32 17)
; CHECK-NEXT:    store x86_fp80 0xK40028000000000000000, ptr [[TMP1]], align 16
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 16
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__lightsan_pre_load(ptr [[ARRAYIDX]], ptr [[TMP2]], i32 10, i32 18)
