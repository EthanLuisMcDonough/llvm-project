...
define i32 @src_i32_check_no_overflow(i32 %a) {
...
define <4 x i32> @src_v4i32_nsw(<4 x i32> %a) {
...
define i128 @src_i128_nuw(i128 %a) {
...
define i32 @src_i32_check_overflow(i32 %a) {
...
define i32 @src_i32_max_2(i32 %a) {
